    ...
    <div className="parent">
      {jobOpenings.map(function (elem, index) {
        ...
        return <div key={index}>
          <Card key={index} company={elem.companyName} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} datePosted={elem.datePosted} brandLogo={elem.brandLogo} pay={elem.pay} location={elem.location}/>
          </div>
      })}
    </div>
  )
...
/* 
  make an array of 10 objects of job openings, I want properties brandLogo, name of company, date posted (like 5 days ago, 10 weeks ago), post, tag1 (like part time or full time), tag2 (like junior level or senior level), pay(in dollars per hour), location(like mumbai, india)
